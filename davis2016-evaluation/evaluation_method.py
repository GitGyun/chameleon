...
default_davis_path = path_dict['davis2017'].replace('2017', '')
...
parser.add_argument('--results_path', type=str, help='Path to the folder containing the sequences folders',
                    required=True)
parser.add_argument("--year", '-y', type=str, help="Davis dataset year (default: 2016)", default='2016',
...
args.davis_path = f'{default_davis_path}/{args.year}'
...
if os.path.exists(csv_name_global_path) and os.path.exists(csv_name_per_sequence_path) and not args.reset_mode:
    ...
    with open(csv_name_per_sequence_path, 'w') as f:
        ...
        table_seq.to_csv(f, index=False)
